    ...
    return (
        ...
        <nav> 
            ...
            <ul  className="sm:grid md:flex flex-row">
                <span className="flex flex-center flex-1"><li><Link to="/osa"><img className="w-64 m-4 sm:grid" src="https://raw.githubusercontent.com/lukaszchwalisz/osa/main/src/assets/images/Web_logo.svg" alt="logo OSA"></img></Link></li></span>
