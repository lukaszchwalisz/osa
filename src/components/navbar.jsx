    ...
    return (
        ...
        <nav> 
            <ul  className="flex flex-row justify-end">
                <span className="flex flex-center flex-1"><li><Link to="/osa/"><img className="w-64" src="https://raw.githubusercontent.com/lukaszchwalisz/osa/main/images/Web_logo_fit2.png" alt="logo OSA"></img></Link></li></span>
