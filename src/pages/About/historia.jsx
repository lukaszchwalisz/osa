...
const Historia = () => {
  return (
    ...
    <article > 
    <h1 className="text-indigo-700 bg-slate-50 p-4 text-center dark:text-slate-300 dark:bg-gray-800 font-bold font-mono text-2xl mt-8 mb-4">POCZĄTKI STOWARZYSZENIA "OSA"</h1>
