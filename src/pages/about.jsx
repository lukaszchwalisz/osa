   ...
   <div className="basis-1/2">
    ...
    <div className="basis-1/2">
      ...
      <ul className="list-disc">
        ...
        <li className="text-slate-500">pomoc osobom zagrożonym i poddawanym mobbingowi</li>
        <li className="text-slate-500">prowadzenie poradnictwa prawnego, psychologicznego i medycznego,
  prowadzenie działalności mediacyjnej</li>
        <li className="text-slate-500">działania na rzecz prawa do pracy w warunkach pozbawionych przemocy psychicznej</li>
        <li className="text-slate-500">współpraca z osobami i instytucjami w zakresie zbierania informacji i wymiany doświadczeń</li>
        <li className="text-slate-500">działania na rzecz ochrony zdrowia osób doświadczających mobbingu</li>
        <li className="text-slate-500">przeciwdziałanie wszelkim przejawom dyskryminacji w miejscu pracy oraz działanie na rzecz równego statusu kobiet i mężczyzn</li>
        <li className="text-slate-500">przeciwdziałanie wykluczeniu społecznemu osób mobbingowanych</li>
      </ul>
    </div>
    </article>
    ...
    <div className="basis-1/2">
      ...
      <ul className="list-disc">
        ...
        <li className="text-slate-500">tworzenie grup samopomocowych i grup wsparcia dla ofiar mobbingu</li>
        <li className="text-slate-500">działalność wydawniczą i dystrybucyjną materiałów edukacyjnych</li>
        <li className="text-slate-500">współpracę z mediami</li>
        <li className="text-slate-500">organizowanie szkoleń w zakresie technik mediacyjnych oraz negocjacyjnych</li>
        <li className="text-slate-500">rozszerzanie działalności przez tworzenie punktów konsultacyjnych i oddziałów na terenie całego kraju</li>
        <li className="text-slate-500">podejmowanie prac badawczych, analiz i ekspertyz związanych z mobbingiem i jego skutkami</li>
        <li className="text-slate-500">szkolenie mediatorów i negocjatorów</li>
        <li className="text-slate-500">pozyskiwanie sponsorów</li>
        <li className="text-slate-500">współpracę z innymi organizacjami w kraju i zagranicą</li>
        <li className="text-slate-500">organizowanie i prowadzenie zjazdów, konferencji, szkoleń i prelekcji</li>
        <li className="text-slate-500">podejmowanie działań zmierzających do powstania prawnych uregulowań przeciwdziałających mobbingowi</li>
        <li className="text-slate-500">inicjowanie, opiniowanie i uczestniczenie w pracach legislacyjnych, dotyczących tematyki związanej z działalnością prowadzoną przez stowarzyszenie</li>
      </ul>
    </div>
    </article>
    ...
    <div className="basis-1/2">
      ...
      <ul className="list-disc">
        ...
        <li className="text-slate-500">chce uczestniczyć w działalności Stowarzyszenia, pomagać innym członkom Stowarzyszenia w realizowaniu zadań statutowych</li>
        <li className="text-slate-500">sumiennie wypełnia uchwały władz Stowarzyszenia</li>
        <li className="text-slate-500">dba o dobry wizerunek Stowarzyszenia i jego członków oraz godnie reprezentuje Stowarzyszenie na zewnątrz</li>
        <li className="text-slate-500">przeciwdziała zachowaniom mobbingowym</li>
        <li className="text-slate-500">przestrzega instrukcji obsługi i kontroli dokumentów, która wprowadza jednolite zasady sporządzania , kontroli i obiegu dokumentów w Stowarzyszeniu oraz jednolity mechanizm działania Stowarzyszenia na terenie całego kraju</li>
        <li className="text-slate-500">regularnie opłaca składki członkowskie w kwocie 5,00 złotych (słownie pięć złotych) miesięcznie</li>
      </ul>
    </div>
    </article>
