    ...
    <>
      ...
      <div className="grid justify-center m-4 mb-20 lg:mx-20 xl:mx-40 2xl:mx-80">
        ...
        <p className="text-slate-500 dark:text-slate-300 mb-4">
          Jeżeli nie chcesz/nie możesz wysłać wiadomości bezpośrednio przez
          swoją skrzykę mailową np.: z powodu{" "}
          <b>braku poczucia bezpieczeństwa</b>, umożliwiamy kontakt poprzez
          formułarz naszej stronie internetowej.
        </p>
        <p className="text-slate-500 dark:text-slate-300 mb-4">
          Wpisz poniżej swoje dane kontaktowe (zgodnie z uznaniem, potrzebne do
          kontaktu) oraz treść wiadomości.
        </p>
