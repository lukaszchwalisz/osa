...
const Wiedza = () => {
  return (
      ...
      <article>
        ...
        organizacji o zhierarchizowanym sposobie zarządzania, umożliwiającym sprawowanie władzy z pozycji siły. Negatywne
        cechy takiej organizacji to bezsensowne polecenia wydawane podwładnym, obarczanie ich dużą odpowiedzialnością przy
        jednoczesnym ograniczaniu uprawnień. Także organizacyjny nieporządek, niekompetentne zarządzanie, zła atmosfera w
        miejscu pracy, brak koleżeńskich zachowań. Niestabilna struktura organizacyjna i brak koordynacji w podejmowaniu decyzji.
        </p>

        <p className="text-slate-500 dark:text-slate-200 mb-4">
        Cechy mobbera najczęściej jest osobą wykształconą, dość młodą na stosunkowo wysokim jak na swój wiek stanowisku.
        Posiada nieadekwatne, bardzo wysokie mniemanie o sobie. Jest przekonany o własnej bardzo wysokiej wartości, 
        wyolbrzymia swoje zdolności, możliwości, umiejętności oraz wiedzę. Na uwagi reaguje wściekłością albo złością.
        Oczekuje, że wszystkie jego decyzje i działania uzyskają bezwzględną aprobatę. Posiada nasilone cechy egocentryzmu
        i autorytarności, nie toleruje sprzeciwu, który traktuje jako uderzenie we własne poczucie wartości i godności,
        a nie odmienne zdanie innej osoby w spornej kwestii. Pracownik, który sprzeciwia się jego zdaniu staje się jego wrogiem.
        Sam nie ma zaufania do nikogo. Dąży do zniszczenia zaufania między swoimi podwładnymi, wywołuje przekonanie,
        że posiada od niektórych pracowników szczególne informacje, co powoduje narastanie atmosfery wzajemnej nieufności,
        szczególnej ostrożności, zazdrości, zawiści i destrukcji.
        </p>
        
        <p className="text-slate-500 dark:text-slate-200 mb-4">
        Szczególna pozycja społeczna ofiary trzeci z czynników dotyczący szczególnej pozycji społecznej ofiary to np. fakt,
        że wywodzi się ona z innego kręgu kulturowego, posiada inną hierarchię wartości niż przełożony lub współpracownicy,
        inne przekonania religijne czy orientację seksualną. Ogólnie można powiedzieć, że dotyczy osób w jakiś szczególny
      ...
      <article>
        ...
        <ul className="list-disc">
          <li className="text-slate-500 dark:text-slate-200 ">oprawca chroniczny, któremu szykanowanie innych daje satysfakcję. Najczęściej wynika to z zaburzeń osobowości</li>
          <li className="text-slate-500 dark:text-slate-200 ">oprawca przypadkowy, który działa w sposób nieświadomy i można powiedzieć, że niechcący</li>
          <li className="text-slate-500 dark:text-slate-200 mb-4">oprawca oportunista, który nie cofnie się przed niczym, żeby osiągnąć swój cel. Jeżeli dąży do awansu, a sytuacja w firmie i okoliczności, w jakich znajduje się jego potencjalna ofiara mu sprzyjają, zaatakuje</li>
        </ul>
        <p className="text-slate-500 dark:text-slate-200 mb-4">
        ...
        <ul className="list-disc">
          <li className="text-slate-500 dark:text-slate-200 ">"dwugłowy wąż" - (doktor Jekyll i mister Hyde); jakoest to człowiek z pozoru życzliwy zainteresowanym, dlatego ludzie mu ufają. Oczekuje od innych informacji pogrążających upatrzoną ofiarę. Uniemożliwia jej wykonywanie obowiązków poprzez zatajanie i fałszowanie danych. Przypisuje sobie sukcesy swojej ofiary, jednocześnie oficjalnie ze współczuciem odnosząc się do jego porażek. Jest to osoba obłudna i dwulicowa</li>
          <li className="text-slate-500 dark:text-slate-200 ">"wieczny kłamca", który innych i ich działania ocenia negatywnie, natomiast swoje uważa za perfekcyjnie wykonane. Taki człowiek ostentacyjnie lekceważy wypowiedzi innych, przybiera obraźliwe miny i gesty, w sposób napastliwy rozmawia z pogardzanymi przez siebie ludźmi</li>
          <li className="text-slate-500 dark:text-slate-200 ">"dyktator" - demonstruje swoją władzę przez kontrolowaniem działań pracowników, ich korespondencję i dokumenty, ignorowanie przyjętych norm i reguł, próby odizolowania pracownika od reszty grupy</li>
          <li className="text-slate-500 dark:text-slate-200 mb-4">"krzykliwa Mimi" - to osoba hałaśliwa, wybuchowa i impulsywna, przez co wprowadza atmosferę nerwowości i chaosu</li>
        </ul>
        <p className="text-slate-500 dark:text-slate-200 mb-4">
        L. Glass (1997) wyróżnia cztery typy ludzi toksycznych nadając im nieco odmienne nazwy i charakterystyki:
        </p>
        <ul className="list-disc">
          <li className="text-slate-500 dark:text-slate-200">"bezwzględni tyrani", czyli osoby nieżyczliwe, nieobliczalne i aroganckie; tyrani dążą do tego, aby wszystko było podporządkowane ich woli. Są uparci, nie empatyczni i gwałtowni. Czerpią radość z poniżania innych</li>
          <li className="text-slate-500 dark:text-slate-200">"napastliwi krytycy", którzy są małostkowi i żądają przesadnej perfekcji; bez skrępowania wytykają niedociągnięcia innych osób, są w tym cyniczni</li>
          <li className="text-slate-500 dark:text-slate-200">"maniacy kontroli", którzy chcą panować nad wszystkim; są sztywni w swoich działaniach i łatwo wpadają w gniew, gdy sprawy wymykają im się spod kontrol</li>
          <li className="text-slate-500 dark:text-slate-200 mb-4">"chodząca doskonałość", czyli osoby samolubne; uważają się za nieomylne i wszystkowiedzące, a przez to lepsze od innych. Gdy coś idzie niezgodnie z ich sztywnym planem zaprzeczają temu kryjąc się za parawanem hipokryzji</li>
      ...
      <ul className="list-decimal">
          <li className="text-slate-500 dark:text-slate-200">Ograniczanie przez przełożonego możliwości wypowiadania się</li>
          <li className="text-slate-500 dark:text-slate-200">Stałe przerywanie wypowiedzi</li>
          <li className="text-slate-500 dark:text-slate-200">Ograniczanie przez kolegów możliwości wypowiadania się</li>
          <li className="text-slate-500 dark:text-slate-200">Reagowanie na uwagi krzykiem lub głośnym wymyślaniem i pomstowaniem</li>
          <li className="text-slate-500 dark:text-slate-200">Ciągłe krytykowanie wykonywanej pracy</li>
          <li className="text-slate-500 dark:text-slate-200">Ciągłe krytykowanie życia prywatnego</li>
          <li className="text-slate-500 dark:text-slate-200">Napastowanie przez telefon</li>
          <li className="text-slate-500 dark:text-slate-200">Ustne groźby i pogróżki</li>
          <li className="text-slate-500 dark:text-slate-200">Groźby na piśmie</li>
          <li className="text-slate-500 dark:text-slate-200">Ograniczanie kontaktu przez poniżające, upokarzające gesty i spojrzenia</li>
          <li className="text-slate-500 dark:text-slate-200 mb-4">Różnego rodzaju aluzje, bez jasnego wyrażania się wprost</li>

          <p className="text-slate-500 font-bold dark:text-slate-200 dark:font-bold mb-4">
        Oddziaływania zaburzające stosunki społeczne:
        </p>

        <li className="text-slate-500 dark:text-slate-200">Unikanie przez przełożonego rozmów z ofiarą</li>
        <li className="text-slate-500 dark:text-slate-200">Nie dawanie możliwości odezwania się</li>
        <li className="text-slate-500 dark:text-slate-200">W pomieszczeniu, gdzie ofiara pracuje, przesadzenie na miejsce z dala od kolegów</li>
        <li className="text-slate-500 dark:text-slate-200">Zabronienie kolegom rozmów z ofiarą</li>
        <li className="text-slate-500 dark:text-slate-200 mb-4">Traktowanie jak powietrze</li>

        <p className="text-slate-500 font-bold dark:text-slate-200 dark:font-bold mb-4">
        Działania mające na celu zaburzyć społeczny odbiór osoby:
        </p>
        <li className="text-slate-500 dark:text-slate-200">Mówienie źle za plecami danej osoby</li>
        <li className="text-slate-500 dark:text-slate-200">Rozsiewanie plotek</li>
        <li className="text-slate-500 dark:text-slate-200">Podejmowanie prób ośmieszenia</li>
        <li className="text-slate-500 dark:text-slate-200">Sugerowanie choroby psychicznej</li>
        <li className="text-slate-500 dark:text-slate-200">Kierowanie na badanie psychiatryczne</li>
        <li className="text-slate-500 dark:text-slate-200">Wyśmiewanie niepełnosprawności czy kalectwa</li>
        <li className="text-slate-500 dark:text-slate-200">Parodiowanie sposobu chodzenia, mówienia lub gestów w celu ośmieszenia osoby</li>
        <li className="text-slate-500 dark:text-slate-200">Nacieranie na polityczne albo religijne przekonania</li>
        <li className="text-slate-500 dark:text-slate-200">Żarty i prześmiewanie życia prywatnego</li>
        <li className="text-slate-500 dark:text-slate-200">Wyśmiewanie narodowości</li>
        <li className="text-slate-500 dark:text-slate-200">Zmuszanie do wykonywania prac naruszających godność osobistą</li>
        <li className="text-slate-500 dark:text-slate-200">Fałszywe ocenianie zaangażowania w pracy</li>
        <li className="text-slate-500 dark:text-slate-200">Kwestionowanie podejmowanych decyzji</li>
        <li className="text-slate-500 dark:text-slate-200">Wołanie na ofiarę używając sprośnych przezwisk lub innych wyrażeń, mających ją poniżyć</li>
        <li className="text-slate-500 dark:text-slate-200">Zaloty lub słowne propozycje seksualne</li>
        <li className="text-slate-500 dark:text-slate-200">Nie dawanie ofierze żadnych zadań do wykonania</li>
        <li className="text-slate-500 dark:text-slate-200">Odbieranie prac, zadanych wcześniej do wykonania</li>
        <li className="text-slate-500 dark:text-slate-200">Zlecanie wykonania prac bezsensownych</li>
        <li className="text-slate-500 dark:text-slate-200">Dawanie zadań poniżej jego umiejętności</li>
        <li className="text-slate-500 dark:text-slate-200">Zarzucanie wciąż nowymi pracami do wykonania</li>
        <li className="text-slate-500 dark:text-slate-200">Polecenia wykonywania obraźliwych dla ofiary zadań</li>
        <li className="text-slate-500 dark:text-slate-200 mb-4">Dawanie zadań przerastających możliwości i kompetencje ofiary w celu jej zdyskredytowania</li>

        <p className="text-slate-500 font-bold dark:text-slate-200 dark:font-bold mb-4">
        Działania mające szkodliwy wpływ na zdrowie ofiary:
        </p>

        <li className="text-slate-500 dark:text-slate-200">Zmuszanie do wykonywania prac szkodliwych dla zdrowia</li>
        <li className="text-slate-500 dark:text-slate-200">Grożenie przemocą fizyczną</li>
        <li className="text-slate-500 dark:text-slate-200">Stosowanie niewielkiej przemocy fizycznej</li>
        <li className="text-slate-500 dark:text-slate-200">Znęcanie się fizyczne</li>
        <li className="text-slate-500 dark:text-slate-200">Przyczynianie się do ponoszenia kosztów, w celu zaszkodzenia poszkodowanemu</li>
        <li className="text-slate-500 dark:text-slate-200">Wyrządzanie szkód psychicznych w miejscu zamieszkania, lub miejscu pracy ofiar</li>           
        <li className="text-slate-500 dark:text-slate-200 mb-4">Działania o podłożu seksualnym</li>
      ...
      <article>
        ...
        których zadaniem jest intensywne i w miarę możliwości szczegółowe poznanie tego terminu.
        Skala tego zjawiska, zdefiniowanie oraz chęć przeciwdziałania wymusza na ustawodawcy stworzenie
        ...
        <p className="text-slate-500 dark:text-slate-200 mb-4">
        Konstytucja uznaje wolność człowieka za jedno z najwyżej cenionych jego dóbr:</p>
        <p className="text-slate-500 italic dark:text-slate-200  mb-4">
        Art. 31. 1. Wolność człowieka podlega ochronie prawnej.
        </p>
        <p className="text-slate-500 italic dark:text-slate-200  mb-4">
        Art. 31. 2. Każdy jest obowiązany szanować wolność i prawa innych. Nikogo nie wolno zmuszać do czynienia tego,
        czego prawo mu nie nakazuje.
        </p>
        <p className="text-slate-500 italic dark:text-slate-200  mb-4">
        Art. 47. Każdy ma prawo do ochrony prawnej życia prywatnego, rodzinnego, czci i dobrego imienia oraz do decydowania
        o swoim życiu osobistym.
        </p>
        <p className="text-slate-500 dark:text-slate-200 mb-4">
        Ustawa zasadnicza wprowadza również kontrolę państwa nad warunkami wykonywania pracy,
        która musi odpowiadać ustalonym standardom:</p>
        <p className="text-slate-500 italic dark:text-slate-200  mb-4">
        Art. 24. Praca znajduje się pod ochroną Rzeczypospolitej Polskiej. Państwo sprawuje nadzór nad warunkami
        wykonywania pracy.
        </p>
        <p className="text-slate-500 italic dark:text-slate-200  mb-4">
        ...
        Zobowiązał też pracodawcę do przeciwdziałania zjawisku mobbingu w podległej mu jednostce organizacyjnej w art. 94(3) §1 KP:
        <i> "Pracodawca jest obowiązany przeciwdziałać mobbingowi."</i></p>

        <p className="text-slate-500 dark:text-slate-200 mb-4">
        Oznacza to, że pracodawca nawet, jeśli sam nie mobbinguje, a jedynie ( przymyka oko) na zachowania innych
        pracowników, które mobbingują, odpowiada za złamanie obowiązków pracodawcy. Pracodawca musi w obecnej 
        sytuacji aktywnie działać, aby takie zjawisko w danym zakładzie pracy nie powstawało. Nie może zasłaniać
        się on niewiedzą w tym temacie.</p>
        ...
        podstawie odrębnych przepisów."</i></p>
